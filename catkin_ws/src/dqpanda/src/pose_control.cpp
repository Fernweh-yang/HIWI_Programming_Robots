...
int main(int argc, char **argv){
    ...
    std::cout << "test3:"<<vi.get_object_pose("Franka_joint1") <<std::endl;
    //todo:end
    ...
    // vi.set_object_pose("Franka_link1", franka.fkm(qd));
    ...
    //     // vi.set_object_pose("Franka_link1", franka.fkm(q));
